    ...
    if (empty($errors)) {
        ...
        try {
            ...
            while ($item = $cart_items->fetch_assoc()) {
                ...
                $stmt->bind_param("iiid", $order_id, $item['book_id'], $item['quantity'], $unit_price);
                $stmt->execute();
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <small class="text-muted">Qty: <?php echo $item['quantity']; ?> × <?php echo formatPrice($unit_price); ?></small>
                        <?php else: ?>
                        <small class="text-muted">Qty: <?php echo $item['quantity']; ?></small>
                        <?php endif; ?>
                    </div>
                    <span class="fw-bold"><?php echo formatPrice($unit_price * $item['quantity']); ?></span>
                </div>
                <?php endwhile; ?>
                <hr>
